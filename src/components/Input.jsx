// export default function Input({ searchHandler, searched, handleClick }) {
//   return (
//     <div className="relative">
//       <div className=" flex w-[400px] border-2 h-[60px] rounded-[48px] shadow-lg py-[16px] px-[24px]">
...
//         searched
//           .slice(0, 10)
//           .map((city) => <p onClick={() => handleClick(city)}>{city}</p>)}
//     </div>
//   );
// }
